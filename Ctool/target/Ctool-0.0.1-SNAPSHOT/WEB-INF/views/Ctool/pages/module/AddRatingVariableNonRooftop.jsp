            ...
            <form role="form" name="myForm">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-example-wrap">
                        <div class="cmp-tb-hd">
                            <h2>Employee Rating Variable Non RoofTop (67%)</h2>
						...
						<div class="form-group">
                         ...
                         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                           ...
                           <div class="form-group">
							...
							<button class="btn btn-success notika-btn-success" ng-click="addVariableRating()" ng-disabled="vars.ratMin > vars.ratMax || myForm.$invalid "><i class="fa fa-save"></i>&nbsp;&nbsp;Submit</button>
							</div>
						</div>
                            </div>
                        </div>
              ...
              <table id="example1" class="table table-bordered table-striped" >
                ...
                <tr ng-repeat="ratingvariable in employeeVariblelistnonRoofTop | filter : search">
                 <td>{{$index+1}}</td>
