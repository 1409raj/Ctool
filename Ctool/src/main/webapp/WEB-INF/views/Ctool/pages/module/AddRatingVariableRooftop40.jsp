            ...
            <form role="form" name="myForm">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-example-wrap">
                        <div class="cmp-tb-hd">
                            <h2>Company Variable  RoofTop (40%)</h2>
                           
                        </div>
                        <div class="row">
                       <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                           <div class="form-group">
							<label>Company Variable (40 % )</label>
                           ...
                           <div class="form-group">
							...
							<button class="btn btn-success notika-btn-success" ng-click="addRoofTopVariable()" ng-disabled="vars.ratMin > vars.ratMax || myForm.$invalid "><i class="fa fa-save"></i>&nbsp;&nbsp;Submit</button>
							</div>
						</div>
                            </div>
              ...
              <table id="example1" class="table table-bordered table-striped" >
                ...
                <tr ng-repeat="ratingvariable in ratingvariableListRooftop | filter : search">
                 <td>{{$index+1}}</td>
